...
/**
 * Un 401 significa que el token caduco o dejo de ser valido: se limpia la
 * sesion y se manda al login. Se hace aqui, en un solo sitio, y no en cada
 * pantalla.
 *
 * Se excluye el propio login para que unas credenciales incorrectas muestren
 * su mensaje en el formulario en vez de provocar una redireccion.
 */
 ...
 * La API devuelve `message` como string o como lista (errores de validacion).
 */
...
/** Errores de validacion por campo, para pintarlos debajo de cada input. */
